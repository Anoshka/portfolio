  ...
  return (
    <>
      ...
      <p className="about__description">
        Hello! I'm Anoshka! I'm a programmer with over four years of experience
        as a Rigging/Creature Technical Director in the animation industry. I
        started off as an artist and quickly discovered how much I love
        developing tools to support my teammates, and make workflows more
        ...
        and collaborating with amazing and motivated people. I can't wait to
        bring my skills to my work as a developer!
      </p>
    </>
  );
}
