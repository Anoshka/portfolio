...
function AutoRiggerPage() {
  return (
    <div>
      A powerful automation tool designed to streamline the character rigging
      process. This tool significantly reduces the manual effort required,
